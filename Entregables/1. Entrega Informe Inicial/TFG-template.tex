...
\fancyhead[RO]{\thepage}
\fancyhead[LE]{\thepage}
\fancyhead[RE]{\scriptsize EE/UAB TFG INFORMÀTICA: IMPROVING THE USABILITY OF A VIDEO-SEE-THROUGH HEAD-MOUNTED DISPLAY USING FOCUS ADAPTATION AND DoF BLUR}
