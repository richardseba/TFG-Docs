...
\begin{document}
	...
	\fancypagestyle{primerapagina}
	{
	   ...
	   \fancyfoot[C]{\scriptsize July 2018, Escola d'Enginyeria (UAB)}
	}
 ...
 \end{figure}
	...
	%Third, it may be necessary test each setting also in its original distance to ensure that the users have set it correctly.
