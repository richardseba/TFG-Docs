...
\begin{document}
	...
	\label{sec:roiresize}
	falta solo esta parte, hablar de los problemas con las esquinas y ver si eso afecta en el output para clasificar
	...
	On the other hand can be found the minimum operation which output cannot be distinguished in medium and far distances. Using the max operation throws an interesting effect, with the original size the output is not stable enough and the medium and near classes cannot be distinguish but in reduced sizes this output stabilizes and the 3 classes can be detected again.
