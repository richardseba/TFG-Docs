...
\begin{document}
	...
	explicacion del proyecto, motivacion, estado inicial del desarrollo (trabajo hecho en practicas)
	...
	en este apartado hablare sobre que tecnicas se han usado para realizar la calibracion y como se ha implementado y estructurado.
	
	\subsection{Libelas}
	en este apartado se explicaran las razones por las que se usa esta libreria, para que sirve, como se utiliza y que necesita para obtener la profundidad (imagenes epipolares, texturas heterogeneas etc.)
	
	\subsection{Recording }
	%grabacion, y captura del dataset
	en este apartado se hablara del modulo de grabacion, y el pipeline paralelo (sin usar el viewer) que se montó para hacer funcionar el sistema en tiempo real y poder realizar los primeros analisis.
	
	\subsection{Accomodation-Vergence}
	aqui se explicara el problema de la acomodation vergence y como trataremos de solucionarlo (quizas esto tendria que estar antes y aqui hacer un apartado mas tecnico y menos explicativo sobre Accomodation-Vergence en si)
