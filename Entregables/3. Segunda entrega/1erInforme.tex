...
\begin{document}
	...
	%Este proyecto esta en su origen por la realizacion de unas practicas en el centro de vision por computador durante el verano de 2017. durante mi tiempo alli, estuve trabajando en un video-see-through viewer para unas gafas de realidad virtual desarrolladas en el CVC. En el periodo del desarrollo de este projecto nos dimos cuenta que el principal inconveniente en la utilizacion de este producto era el mareo y el motion sickness que producia. Por esto este trabajo se dedicara a investigar distintas formas de reducir este mareo y a ampliar las funcionalidades del visor.
