...
\begin{document}
	...
	\begin{landscape}
		\begin{figure}
			...
			\caption{Gantt diagram of the project. Note that red blue task are remaining tasks, grey task are done tasks, red task are tasks not done in the scheduled time and orange task are rescheduled tasks }
			\label{fig:gantt}
		\end{figure}
